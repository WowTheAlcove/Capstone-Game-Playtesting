...
var ASM_CONSTS = {
  4685816: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4685871: ($0) => { performance.now = function() { return $0; }; },  
 4685919: ($0) => { performance.now = function() { return $0; }; },  
 4685967: () => { performance.now = Module['emscripten_get_now_backup']; }
};
