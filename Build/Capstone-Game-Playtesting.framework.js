...
var ASM_CONSTS = {
  4689096: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4689151: ($0) => { performance.now = function() { return $0; }; },  
 4689199: ($0) => { performance.now = function() { return $0; }; },  
 4689247: () => { performance.now = Module['emscripten_get_now_backup']; }
};
