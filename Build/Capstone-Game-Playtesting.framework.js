...
var ASM_CONSTS = {
  4689784: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4689839: ($0) => { performance.now = function() { return $0; }; },  
 4689887: ($0) => { performance.now = function() { return $0; }; },  
 4689935: () => { performance.now = Module['emscripten_get_now_backup']; }
};
