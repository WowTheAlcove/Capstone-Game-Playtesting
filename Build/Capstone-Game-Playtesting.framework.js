...
var ASM_CONSTS = {
  4686024: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4686079: ($0) => { performance.now = function() { return $0; }; },  
 4686127: ($0) => { performance.now = function() { return $0; }; },  
 4686175: () => { performance.now = Module['emscripten_get_now_backup']; }
};
