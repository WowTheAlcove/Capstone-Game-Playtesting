...
var ASM_CONSTS = {
  4685992: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4686047: ($0) => { performance.now = function() { return $0; }; },  
 4686095: ($0) => { performance.now = function() { return $0; }; },  
 4686143: () => { performance.now = Module['emscripten_get_now_backup']; }
};
