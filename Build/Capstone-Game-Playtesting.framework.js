...
var ASM_CONSTS = {
  4689288: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4689343: ($0) => { performance.now = function() { return $0; }; },  
 4689391: ($0) => { performance.now = function() { return $0; }; },  
 4689439: () => { performance.now = Module['emscripten_get_now_backup']; }
};
