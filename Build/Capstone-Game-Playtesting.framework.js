...
var ASM_CONSTS = {
  4689352: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4689407: ($0) => { performance.now = function() { return $0; }; },  
 4689455: ($0) => { performance.now = function() { return $0; }; },  
 4689503: () => { performance.now = Module['emscripten_get_now_backup']; }
};
