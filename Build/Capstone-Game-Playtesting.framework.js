...
var ASM_CONSTS = {
  4689688: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4689743: ($0) => { performance.now = function() { return $0; }; },  
 4689791: ($0) => { performance.now = function() { return $0; }; },  
 4689839: () => { performance.now = Module['emscripten_get_now_backup']; }
};
