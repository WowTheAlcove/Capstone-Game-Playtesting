...
var ASM_CONSTS = {
  4686824: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4686879: ($0) => { performance.now = function() { return $0; }; },  
 4686927: ($0) => { performance.now = function() { return $0; }; },  
 4686975: () => { performance.now = Module['emscripten_get_now_backup']; }
};
