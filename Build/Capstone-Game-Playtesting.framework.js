...
var ASM_CONSTS = {
  4687208: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4687263: ($0) => { performance.now = function() { return $0; }; },  
 4687311: ($0) => { performance.now = function() { return $0; }; },  
 4687359: () => { performance.now = Module['emscripten_get_now_backup']; }
};
